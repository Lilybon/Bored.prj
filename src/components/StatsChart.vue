...
export default {
  ...
  methods: {
    ...
    groupBarChart(width, height) {
      ...
      xScale1
        .domain(["likeCount", "dislikeCount"])
        .range([0, xScale0.bandwidth()]);

      yScale.domain([
        0,
        d3.max(this.data, d =>
          d.likeCount > d.dislikeCount ? d.likeCount : d.dislikeCount
        )
      ]);

      var activityTypeGroup = svg
        .selectAll(".group-bar-chart__activity-type")
        .data(this.data)
        .enter()
        .append("g")
      ...
      activityTypeGroup
        .selectAll(".group-bar-chart__bar--like-count")
        .data(d => [d])
        .enter()
        .append("rect")
      ...
      activityTypeGroup
        .selectAll(".group-bar-chart__bar--dislike-count")
        .data(d => [d])
        .enter()
        .append("rect")

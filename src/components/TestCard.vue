...
export default {
  ...
  methods: {
    ...
    spinShow() {
      ...
      this.classObject["introjs-showElement"] = this.first ? true : false; // cause introjs css style failed to hook on element, add it initially by coding.

        ...
        <v-layout class="panel" row wrap pa-2>
            <v-flex pa-2 xs12>
                ...
                <p v-if="listFound" class="panel-content__description panel-content--slide-from-right">
                    哈囉，我為無聊的你訂做了一系列值得浪費時間的清單，<br/>
                    如果喜歡的話請推薦給親朋好友試試，<br/>
                    活動都不中意的話可以點選再玩一次重新搜尋。
                </p>
            </v-flex>
            ...
            <v-flex class="not-found" v-if="listNotFound" pa-2 xs12>
                <p class="panel-content__description panel-content--slide-from-right">
                    呃 看來我們的bored.api出了點小毛病...
                </p>
                <div class="not-found__container">
                     <img class="not-found__image" alt="抱歉，無法找到符合您要求的活動。" src="https://static.newmobilelife.com/wp-content/uploads/2018/04/buddha-maker_00.jpg"/>
                     <p class="not-found__title">not found</p>
                     <p class="not-found__content">抱歉<br/>無法找到符合您要求的活動</p>
                </div>
            </v-flex>
            <ActCard 
                v-for="activity in actList" 
                :key="activity.key"
                :activity="activity"
            />
